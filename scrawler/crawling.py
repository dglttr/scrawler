...
class Crawler:
    def __init__(self, urls: Union[str, List[str]],
        ...
        :param parallel_processes: Number of concurrent processes/threads to use. This can be very large when using
            the `asyncio` backend, but should not exceed 2x the CPU count on the machine running the crawling.
